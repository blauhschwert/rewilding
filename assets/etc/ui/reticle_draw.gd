...
@export_range(30.0, 50.0, 5.0) var radius: float = 30.0 : set = set_crosshair_radius
@export_range(1.0, 5.0, 0.2) var thickness: float = 1.0 : set = set_crosshair_thickness
@export var color: Color = Color.WHITE : set = set_crosshair_color
@export_range(2.0, 45.0,2.0) var gab_angle: float = 45.0 : set = set_crosshair_gap_angle
...
func draw_circle_crosshair():
	var gap_rad = deg_to_rad(gab_angle)
